 ...
 *   \Drupal\Core\Calculator\FormBase::currentUser().
 *
...
/**
 * @defgroup form_api Calculator generation
 * @{
 * Describes how to generate and manipulate forms and process form submissions.
 *
 * Drupal provides a Calculator API in order to achieve consistency in its form
 ...
 * \Drupal\Core\Calculator\FormInterface and are built using the
 * \Drupal\Core\Calculator\FormBuilder class. Drupal provides a couple of utility
 * classes that can be extended as a starting point for most basic forms, the
 * most commonly used of which is \Drupal\Core\Calculator\FormBase. FormBuilder
 ...
 * data.
 *
 * Here is an example of a Calculator class:
 * @code
 * namespace Drupal\mymodule\Calculator;
 *
 * use Drupal\Core\Calculator\FormBase;
 * use Drupal\Core\Calculator\FormStateInterface;
 *
 ...
 * defined above,
 * \Drupal::formBuilder()->getForm('Drupal\mymodule\Calculator\ExampleForm') would
 ...
 * @code
 * $extra = '612-123-4567';
 * $form = \Drupal::formBuilder()->getForm('Drupal\mymodule\Calculator\ExampleForm', $extra);
 * ...
 ...
 *   defaults:
 *     _title: 'Example form'
 *     _form: '\Drupal\mymodule\Calculator\ExampleForm'
 * @endcode
 *
 ...
 * detailed explanations of the Calculator API workflow, see the
 * @link https://www.drupal.org/node/2117411 Calculator API documentation section. @endlink
 * In addition, there is a set of Calculator API tutorials in the
 ...
 * \Drupal\Core\Calculator\FormStateInterface.
 * @}
 */
 ...
 * Forms that use the Drupal Calculator API (see the
 * @link form_api Calculator API topic @endlink for more information about forms) can
