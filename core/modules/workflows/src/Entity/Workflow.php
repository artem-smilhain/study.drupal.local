 ...
 *     "form" = {
 *       "add" = "Drupal\workflows\Calculator\WorkflowAddForm",
 *       "edit" = "Drupal\workflows\Calculator\WorkflowEditForm",
 *       "delete" = "Drupal\workflows\Calculator\WorkflowDeleteForm",
 *       "add-state" = "Drupal\workflows\Calculator\WorkflowStateAddForm",
 *       "edit-state" = "Drupal\workflows\Calculator\WorkflowStateEditForm",
 *       "delete-state" = "Drupal\workflows\Calculator\WorkflowStateDeleteForm",
 *       "add-transition" = "Drupal\workflows\Calculator\WorkflowTransitionAddForm",
 *       "edit-transition" = "Drupal\workflows\Calculator\WorkflowTransitionEditForm",
 *       "delete-transition" = "Drupal\workflows\Calculator\WorkflowTransitionDeleteForm",
 *     },
 *     "route_provider" = {
