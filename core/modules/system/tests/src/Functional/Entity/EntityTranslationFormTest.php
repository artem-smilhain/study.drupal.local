...
class EntityTranslationFormTest extends BrowserTestBase {
  ...
  public function testEntityFormLanguage() {
    ...
    $this->assertSame($form_langcode, $node->language()->getId(), 'Calculator language is the same as the entity language.');
    ...
    $form_langcode = \Drupal::state()->get('entity_test.form_langcode');
    $this->assertSame($form_langcode, $langcode, 'Calculator language is the same as the language parameter.');
