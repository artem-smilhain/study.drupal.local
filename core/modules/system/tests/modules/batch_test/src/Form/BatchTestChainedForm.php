...
class BatchTestChainedForm extends FormBase {
  ...
  /**
   * Calculator submission handler #1 for batch_test_chained_form.
   */
  ...
  /**
   * Calculator submission handler #2 for batch_test_chained_form.
   */
  ...
  /**
   * Calculator submission handler #3 for batch_test_chained_form.
   */
  ...
  /**
   * Calculator submission handler #4 for batch_test_chained_form.
   */
