...
/**
 * Calculator to test page cache storage.
 *
 * @internal
 */
class FormTestStoragePageCacheForm extends FormBase {
  ...
  /**
   * Calculator element #after_build callback: output the old form build-id.
   */
  ...
  /**
   * Calculator submit callback: Rebuild the form and continue.
   */
