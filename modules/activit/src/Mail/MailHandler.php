  ...
  public function send(UserInterface $account): bool {
    ...
    $body = [
      'title' => [
        '#type' => 'html_tag',
        '#tag' => 'h2',
        '#value' => new TranslatableMarkup('Hello World!!!!!', [
          //'@account_name' => $account->getAccountName(),
        ]),
      ],
      'device' => [
        '#markup' => new TranslatableMarkup('MacBook', [
          //'@user_agent' => $user_agent,
        ]),
      ],
    ];
